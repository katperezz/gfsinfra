...
$sqlselect =  "select*from laptop where status<>'deleted'";
...
cellColor('L3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "acquisition_date"); 
cellColor('M3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "LTTPS"); 
cellColor('N3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "NBD"); 
cellColor('O3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "POW"); 
cellColor('P3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "proSupport_IT_tech"); 
cellColor('Q3', 'CCEEFF');
$objPHPExcel->getActiveSheet()->SetCellValue('L3', "remarks"); 
cellColor('R3', 'CCEEFF');
